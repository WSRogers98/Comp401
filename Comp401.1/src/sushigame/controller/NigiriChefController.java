...
public class NigiriChefController implements ChefController {
	...
	private Nigiri.NigiriType pickType() {
		Nigiri.NigiriType[] types = new Nigiri.NigiriType[] { Nigiri.NigiriType.CRAB, Nigiri.NigiriType.EEL,
				Nigiri.NigiriType.SALMON, Nigiri.NigiriType.TUNA, Nigiri.NigiriType.SHRIMP };
		return types[(int) (Math.random() * types.length)];
	}

	private Plate.Color pickColor() {
		Plate.Color[] colors = new Plate.Color[] { Plate.Color.RED, Plate.Color.GREEN, Plate.Color.BLUE };
